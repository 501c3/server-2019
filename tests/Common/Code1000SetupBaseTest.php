...
class Code1000SetupBaseTest extends KernelTestCase
{
    ...
    /**
     * @expectedException \App\Common\AppException
     * @expectedExceptionMessage 'Invalid Model' as (row:1,col:1) is an unrecognized value in file: setup
    ...
    public function test1060InvalidModel()
    {
        ...
        $setup->parseModelValues(__DIR__.'/../../tests/Common/setup-1060-invalid-model.yml');
    }
    ...
    {
        $setup = $this->parseModelsDomainsValues();
        $setup->parseModelValues(__DIR__.'/../../tests/Common/setup-1070-invalid-key.yml');
    }
    ...
    /**
     * @expectedException \App\Common\AppException
     * @expectedExceptionMessage  Missing [status|sex] between lines 2-9 in file: setup-1080-missing-keys.yml.
    ...
    public function test1080MissingKeys()
    {
        /** @var YamlDbSetupBase $setup */
        $setup = $this->parseModelsDomainsValues();
        $setup->parseModelValues(__DIR__.'/../../tests/Common/setup-1080-missing-keys.yml');
    }

    /**
     * @expectedException \App\Common\AppException
     * @expectedExceptionMessage 'Invalid-Value' as (row:6,col:30) is an unrecognized value in file
     *
     * @throws \App\Common\AppException
     * @throws \App\Common\AppException
     * @throws \Doctrine\ORM\ORMException
    ...
    {
        $setup = $this->parseModelsDomainsValues();
        $setup->parseModelValues(__DIR__.'/../../tests/Common/setup-1090-invalid-value.yml');
    }
